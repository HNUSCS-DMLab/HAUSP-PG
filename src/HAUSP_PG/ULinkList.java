...
/**
 * Revised by Kai Cao, Yucong Duan @HNU, and Wensheng Gan @HITsz, China
 */
...
/**
    public int remainLen(int ind) {
        return remainingLen[ind];
    }
    public void setRemainLen(int ind, int remainLen) {
         this.remainingLen[ind] = remainLen;
    }
*/    
